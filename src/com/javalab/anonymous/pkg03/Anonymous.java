...
public class Anonymous {
	...
	public Person person = new Person() {
		...
		@Override
		public void wake() { // 익명으로 오버라이드 해서 자식의 것이 호출됨
	...
	public void method1() {
		// persom 타입의 지역변수 localVar에 익명 객체 생성해서 저장
		...
		// localVar.work(); // 부모에 없는 메소
	} // end method1()

	// 파라미터로 익명 객체를 전달받고 있음.(매개변수의 다형성 적용)
